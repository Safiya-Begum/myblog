...
export class FruitsComponent implements OnInit {
  ...
  postContent:any;
  responseData:any;
  constructor(private _blogService:BlogService, private _callbackService:CustomCallbacksService, private _router:Router, private _activatedRoute:ActivatedRoute) { }
